...
const PRODUTOS_TEMA = {
  ...
  'educacao': ['Apostila Personalizada', 'Agenda Diária 2027', 'Caderninho 7x10 cm', 'Cordão Personalizado', 'Camiseta Dry Fit Masculina', 'Kit Básico Plus', 'Kit All Black', 'Encadernação'],
  ...
  'brindes-e-kit-boas-vindas': ['Kit Básico Plus', 'Kit Luxo', 'Kit All Black', 'Caneta de Metal Touch', 'Chaveiro Acrílico', 'Copo Térmico Inox 500ml', 'Garrafa de Inox 750ml Opus', 'Squeeze Fosca 600ml', 'Ecobag Personalizada', 'Cordão Personalizado', 'Caderninho 7x10 cm'],
  'empresas-e-treinamento': ['Cordão Personalizado', 'Apostila Personalizada', 'Caderninho 7x10 cm', 'Copo Térmico Inox 500ml', 'Camiseta Dry Fit Masculina', 'Ecobag Personalizada', 'Kit Básico Plus'],
